    ...
    <div class="container-fluid d-flex flex-column w-75 position-relative m-0 xl-12">
        ...
        <form class="form-control">
            ...
            <div class ="row">
                ...
                <div class="col-sm">
                    ...
                    <asp:CustomValidator ID="cmFechaNvCURP" runat="server" 
                    ErrorMessage="La fecha de nacimiento del CURP no coincide con la seleccionada anteriormente" CssClass="text-danger position-absolute fw-bold" ControlToValidate="txtCURP"
                    ClientValidationFunction="FechaCURP"></asp:CustomValidator>
            ...
            <div class ="row">
                ...
                <div class="col-sm-3"><asp:DropDownList ID="ddlEstatus" runat="server" CssClass="form-select w-100"></asp:DropDownList>
                    <br />
                </div>
            </div>
            <div class ="row">
        ...
        <script type="text/javascript">
            function FechaCURP(source, args) {
                ...
                let curpFN = args.Value.substr(4, 6);
                let fechaNCurp = fechaN.substr(2, 2) + fechaN.substr(5, 2) + fechaN.substr(8, 2);
