...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container d-flex flex-column w-50 position-relative m-0">
        ...
        <h3>¿Estas seguro que deseas eliminar al Alumno?</h3>
        <div class ="row">
        ...
        <br />
        <div class ="row">
            <div class="col-sm"><asp:Button ID="btnEliminar" runat="server" Text="Eliminar" OnClick="btnEliminar_Click" class="btn btn-light"/></div>
        </div>
        <br />
    </div>
